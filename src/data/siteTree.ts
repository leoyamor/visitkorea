          ...
          content: [
            {
              ...
              icon: "shield",
              emphasis: "Not required - but highly recommended.",
              body:
                "Travel insurance is not mandatory for most short-term visitors. However, if something unexpected happens, you will pay full medical costs as a foreign traveler. Korea's healthcare system is modern and high quality - but it is not free for tourists.",
            },
            {
              title: "What Happens Without Insurance?",
              icon: "alert",
              emphasis: "You pay out of pocket.",
              body: "In real situations:",
              bullets: [
                "Hospitals require payment before discharge.",
                "An emergency room visit in Seoul can cost $300-$800 USD.",
                "One night in a hospital may cost $1,000-$3,000 USD or more.",
                "Tests, scans, or minor procedures quickly increase the bill.",
                "There is no automatic healthcare coverage for tourists.",
              ],
            },
            {
              title: "Common Travel Situations",
              icon: "spark",
              emphasis: "Normal issues, not extreme emergencies.",
              body: "Travelers most often face:",
              bullets: [
                "Food poisoning",
                "Slipping on icy streets in winter",
                "Minor traffic accidents",
                "Severe flu or COVID",
                "Lost luggage or delayed flights",
                "These are everyday travel problems - and they can happen anywhere.",
              ],
            },
            {
              title: "What Coverage Is Practical for Korea?",
              icon: "checklist",
              emphasis: "Keep it simple.",
              body: "Look for a policy that includes:",
              bullets: [
                "Emergency medical coverage (at least $50,000-$100,000 USD)",
                "Hospitalization and ambulance coverage",
                "Trip cancellation or delay",
                "Lost or delayed baggage",
                "You only need adventure coverage if you plan hiking, skiing, or other high-risk activities.",
              ],
            },
            {
              title: "How Much Does It Usually Cost?",
              icon: "wallet",
              emphasis: "Less than most travelers expect.",
              body: "For healthy travelers aged 20-40:",
              bullets: [
                "1 week: $15-$40 USD",
                "2 weeks: $30-$70 USD",
                "These prices are general examples. Actual costs vary depending on your country of residence, age, coverage level, and insurance provider. Always confirm details directly with the insurer.",
              ],
            },
            {
              title: "Final Thought",
              icon: "spark",
              emphasis: "Travel with confidence.",
              body:
                "Most travelers never use their insurance - and that's ideal. Travel insurance simply removes financial risk, so you can enjoy Korea with peace of mind from the moment you land.",
            },
          ],
        },
      ],
